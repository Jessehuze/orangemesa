     ...
     <div class="editProfile">
      <div class="editProfile_form">
       ...
       <div class="editProfile_row">
        ...
        <input name="fname" type="text" class="signup__input username" placeholder="First Name" required/>
       </div>
       <button name="update_fname" type="submit" class="update_fname">Update First Name</button>
      </div>
     </div>
    </div>
   </div>
